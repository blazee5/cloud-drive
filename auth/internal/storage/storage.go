...
type Storage interface {
	SignUp(ctx context.Context, input *pb.SignUpRequest, code string) (string, error)
	VerifyUser(ctx context.Context, input *pb.SignInRequest) (models.User, error)
	GetActivationCode(ctx context.Context, code string) (models.ActivationCode, error)
